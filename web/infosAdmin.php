            ...
            <section>
                <article>
                    <?php
                        ...
                        $querynum3 = "SELECT type_chambre, prix AS Chambre_utiliser_par_Hotel, description from chambre WHERE capacite IS NOT NULL AND prix IS NOT NULL;";
                        ...
                        ///////////
                         ...
                         echo "<p>Chambres réservé aux personnels de l'hôtel</p>";
                         echo "<table border='1' cellspacing='0' class='show_tab'>
                                 <tr>
